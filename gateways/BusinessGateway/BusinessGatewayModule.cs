...
namespace BusinessGateway
{
    ...
    internal class BusinessGatewayModule : AbpModule
    {
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo {Title = "Business Gateway API", Version = "v1"});
        ...
        public override void OnApplicationInitialization(ApplicationInitializationContext context)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "Business Gateway API");
            });
